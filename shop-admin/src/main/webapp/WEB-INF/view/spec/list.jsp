            ...
            "columns": [
...

                {
                    ...
                    "render": function (data, type, row, meta) {
                       ...
                       return "<button type=\"button\" class=\"btn btn-warning\" onclick=\"editSpec('"+data+"');\"><i class=\"glyphicon glyphicon-pencil\"></i>修改</button>\n" +
                           " <button type=\"button\" class=\"btn btn-danger\" onclick=\"deleteSpec('"+data+"')\"><i class=\"glyphicon glyphicon-trash\"></i>删除</button>" +
